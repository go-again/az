...
import (
	...
	lz4block "github.com/go-again/az/internal/lz4/block"
...
func do() error {
	...
	// Resolve imports. Pass the output filename so goimports has directory
	// context to resolve local packages (e.g. lz4block).
	code, err := imports.Process("frame_gen.go", buf.Bytes(), nil)
	if err != nil {
